...
1. Identificar los ingresos y gastos durante un mes. Esto nos permite saber en qué podemos limitar el gasto y en qué y cuando podemos aumentar nuestros ingresos.
...
5. Invierte al menos el 15% de tu salario para el retiro.
