...
Los **Depósitos de bajo monto** o depósitos electrónicos anteriormente conocidos como **Cuentas de Ahorro de Trámite Simplificado (CATS)** están exentas del **4x1000 hasta los 65 UVT** ([ver el articulo de UVT para saber el valor actualizado]({% link docs/uvt.md %})), las restringidas permiten movimientos hasta los 3 salarios mínimos, las que no permiten **hasta 8 SMMLV**.
